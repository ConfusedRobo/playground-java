...
public class Main {
    ...
    public static void main(String[] args) {
        var jane = new PolitePerson("Jane");
        var john = new PolitePerson("John");
    ...
    // It tries to call the sayHelloBack() method
    ...
    static class PolitePerson {
        ...
        // %n is new line
        // format is being used as it has a hig probability of deadlocking
        // it is used to replicate the deadlock situation
