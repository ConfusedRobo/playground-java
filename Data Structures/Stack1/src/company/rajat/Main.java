...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        StackDS list = new StackDS(maxStackValue);
        ...
        while (!quit) {
            ...
            switch (choice) {
                ...
                case 5:
                    ...
                    break;
                case 6:
                    System.out.println("Stack limit: " + maxStackValue);
                    break;
                case 7:
                    System.out.println("Top value: " + list.getTop());
                    break;
                case 8:
    ...
    public static void printMenu() {
        System.out.println("Press\n" +
                           ...
                           "5 - Traverse stack\n" +
                           "6 - Re-view stack limit\n" +
                           "7 - View current top value\n" +
                           "8 - Quit");
    }
}
