...
public class Team<T extends Game> implements Comparable<Team<T>> {
    ...
    private final int scoreFor;
    private final int scoreAgainst;
    private final String scoreDifference;
    private final int points;

    public Team(String name, int drawn, int won, int lost, int played, int scoreFor, int scoreAgainst, String scoreDifference, int points) {
        this.name = name;
        this.drawn = drawn;
        this.won = won;
        this.lost = lost;
